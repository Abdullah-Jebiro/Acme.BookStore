...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 7ed3db23-12fd-47c1-afeb-449744c691ce
```

> `7ed3db23-12fd-47c1-afeb-449744c691ce` is the password of the certificate, you can change it to any password you want.
